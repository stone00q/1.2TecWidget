...
#INCLUDEPATH += E:/ParaView-v5.13.2/install/include/paraview-5.13/
#INCLUDEPATH += E:/ParaView-v5.13.2/install/include/paraview-5.13/AvtAlgorithms/
#LIBS += -L$$quote("E:/ParaView-v5.13.2/install/lib/")
...
#vtkIOXML-pv5.13d.lib\#新加的读入相关
#visit_vtk-pv5.13d.lib\
#vtkIOVisItBridge-pv5.13d.lib\
#}else{
#LIBS+=\
